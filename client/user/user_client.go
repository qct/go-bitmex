...
/*
UserGetExecutionHistory gets the execution history by day
*/
func (a *Client) UserGetExecutionHistory(params *UserGetExecutionHistoryParams, authInfo runtime.ClientAuthInfoWriter) (*UserGetExecutionHistoryOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUserGetExecutionHistoryParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "User.getExecutionHistory",
		Method:             "GET",
		PathPattern:        "/user/executionHistory",
		ProducesMediaTypes: []string{"application/javascript", "application/json", "application/xml", "text/javascript", "text/xml"},
		ConsumesMediaTypes: []string{"application/json", "application/x-www-form-urlencoded"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &UserGetExecutionHistoryReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	return result.(*UserGetExecutionHistoryOK), nil
